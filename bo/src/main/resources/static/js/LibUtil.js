let LibUtil = {
	openContent: function(opts){
		let _this = this;
		
		if(document.getElementById('modal_backop_' + TabUtil.mid) != null) return;
		
		let modal_backop = document.createElement("div");
        modal_backop.className =  "modal_backop dim_";
        modal_backop.id = 'modal_backop_' + TabUtil.mid;
        modal_backop.style.display = "block";
		let modal = document.createElement("div");
		modal.id = 'modal_' + TabUtil.mid;
        modal.className =  "modal";
        let modal_full = document.createElement("div");
        modal_full.className =  "modal_full";
        ...
        modal_title.innerHTML = opts.title;
        ...
        let modal_content_in = document.createElement("div");
        modal_content_in.className =  "modal_content_in";
        modal_content_in.innerHTML = "aaaaaaaaa";
        
        modal_head.append(modal_title);
        modal_head.append(modal_close);
		...
		let params = {
			...
			, success : function(opt,data){
				modal_content_in.innerHTML = data;
				modal_content.append(modal_content_in);
		        modal_full.append(modal_head);
		        modal_full.append(modal_content);
		        modal.append(modal_full);
       			$("#p_"+TabUtil.mid).append(modal);
        		$("#p_"+TabUtil.mid).append(modal_backop);
				...
				DOC = document.getElementById('modal_' + TabUtil.mid);
	        }
		};
		AjaxUtil.get(params);
    },
    closePopup : function(){
		document.getElementById('modal_backop_' + TabUtil.mid).remove();
		document.getElementById('modal_' + TabUtil.mid).remove();
	},
    openDetail: function(opts){
		...
		let params = {
			...
			, param : p
			, success : function(opt,data){
		    	const Element = document.querySelector('.pageDetailBase');
				let cloneEl = Element.cloneNode(true);
				cloneEl.className = 'detailPage';
				cloneEl.id = opts.id;
				let h = document.querySelector('.k_content').clientHeight;
				let w = document.querySelector('.k_right').clientWidth;
				cloneEl.style.display = 'block';
				cloneEl.style.height = h+"px";
				cloneEl.style.width = w+"px";
				cloneEl.querySelector('.pageDetailContent').innerHTML = data;
				$('.k_content').append(cloneEl);
