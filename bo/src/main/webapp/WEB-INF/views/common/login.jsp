...
<div class="login_wrap">
	...
	<div class="tab_cnt">
		<form name="login" action="/j_spring_security" method="POST">
	        <div class="inpbx">
	            <input type="text" id="user_id" name="email" placeholder="아이디 (이메일)" data-vd='{"type":"email","len":"8,20","req":true,"msg":"아이디를 입력하세요"}' value="kkkkkkkk@a.com"/>
			</div>
			<div class="inpbx">
				<input type="password" id="user_password" name="password" placeholder="비밀번호" data-vd='{"type":"text","len":"1,20","req":true,"msg":"비밀번호를 입력하세요"}' value="111"/>
			</div>
