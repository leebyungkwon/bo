...
function pageLoad(){
	document.getElementById('btn_login').onclick = function () {
		var aa = hex_sha512($("#user_password").val()).toString();
...
<div class="login_wrap">
	...
	<div class="tab_cnt">
		<form name="login" action="/j_spring_security" method="POST">
	        <div class="inpbx">
	            <input type="text" id="user_id" name="memberId" placeholder="아이디 (이메일)" data-vd='{"type":"text","len":"5,20","req":true,"msg":"아이디를 입력하세요"}' value="test001"/>
			</div>
			<div class="inpbx">
				<input type="password" id="user_password" name="password" placeholder="비밀번호" data-vd='{"type":"text","len":"1,200","req":true,"msg":"비밀번호를 입력하세요"}' value="1234"/>
			</div>
